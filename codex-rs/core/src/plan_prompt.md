...
- Keep the plan short (3-7 steps) and focused on the code changes needed.
- Include testing/validation steps and note key risks or edge cases.
- After the plan, stop. Do not start implementing.
